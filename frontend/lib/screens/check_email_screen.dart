      ...
      child: Column(
        ...
        children: [
          Wrap(
            ...
            children: [
              TextButton(onPressed: () => Navigator.pushNamed(context, '/terms'), child: const Text('Terms', style: TextStyle(fontSize: 12, color: Colors.white70, decoration: TextDecoration.underline))),
              const Text('•', style: TextStyle(fontSize: 12, color: Colors.white38)),
              TextButton(onPressed: () => Navigator.pushNamed(context, '/privacy'), child: const Text('Privacy', style: TextStyle(fontSize: 12, color: Colors.white70, decoration: TextDecoration.underline))),
              const Text('•', style: TextStyle(fontSize: 12, color: Colors.white38)),
              TextButton(onPressed: () => Navigator.pushNamed(context, '/contact'), child: const Text('Contact', style: TextStyle(fontSize: 12, color: Colors.white70, decoration: TextDecoration.underline))),
            ],
          ),
